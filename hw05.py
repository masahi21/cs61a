...
class VendingMachine:
    ...
    def vend(self):
        ...
        message = 'Here is your {0}'.format(self.item)
        if change != 0:
            message += ' and ${0} change'.format(-change)
        self.balance = 0
        self.stock -= 1
        return message + '.'
...
def deep_map(f, link):
    ...
    lnk = list_to_link(link_to_list(link))
    """
