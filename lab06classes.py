...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for card in player.deck.cards:
            self.card.attack += other_card.attack
            self.card.defense += other_card.defense
        for card in opponent.deck.cards[:]:
            if self.card.attack == other_card.card.attack or self.card.defense == other_card.card.defense:
