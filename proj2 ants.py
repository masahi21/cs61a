...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        A Bee is just removed from the(0,) list of Bees.
        """
        if insect.is_ant:
...
class Bee(Insect):
    ...
    def action(self, colony):
        ...
        # BEGIN EC
        "*** YOUR CODE HERE ***"
        if self.scared is False and self.direction == -1:
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        return not self.contained_ant and other.is_container is False
        # END Problem 9
    ...
    def action(self, colony):
        ...
        if self.impostor:
            ...
            while place:
                ...
                if isinstance(ant, BodyguardAnt) and ant.contained_ant and ant.contained_ant not in self.doubled_ants:
